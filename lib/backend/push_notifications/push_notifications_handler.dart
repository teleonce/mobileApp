...
final parametersBuilderMap =
  ...
  'Programas': ParameterData.none(),
  'Noticias': (data) async => ParameterData(
        allParams: {
          'logo': getParameter<String>(data, 'logo'),
        },
      ),
  'ElTiempo': ParameterData.none(),
  ...
  'Categoria': (data) async => ParameterData(
        allParams: {
          'cat': getParameter<int>(data, 'cat'),
        },
      ),
  'Programa': (data) async => ParameterData(
        allParams: {
          'cat': getParameter<int>(data, 'cat'),
        },
      ),
